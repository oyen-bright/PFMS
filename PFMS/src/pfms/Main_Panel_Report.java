...
public class Main_Panel_Report extends javax.swing.JFrame {
    ...
    public Main_Panel_Report(int data, String data1) {
        this.data=data;
        this.data1=data1;
        this.getData_main();
    ...
    public Main_Panel_Report(int data) {
        this.data=data;
    ...
    public void display(){
        ...
        String date,time;
       DefaultTableModel model=(DefaultTableModel) incomeReportTable.getModel();
           int rowCount = model.getRowCount();
           for (int i = rowCount - 1; i >= 0; i--) {
            model.removeRow(i);
            }
           
        DefaultTableModel model1=(DefaultTableModel) expenseReportTable.getModel();
       ...
       try(Connection con=Sql.getConnection()){
           ...
           try(ResultSet result=pst.executeQuery()){
               ...
               while(result.next()){
                   ...
                   i++;
                  model.addRow(new Object[]{i,date, result.getString("Category"), "$"+result.getString("Amount"),result.getString("Location"), result.getString("Note")
               , time  });
           ...
           sql="SELECT * FROM expense_pfms where Id=? and Username=?";
           pst=con.prepareStatement(sql);
           pst.setInt(1, sessionId);
           pst.setString(2, sessionUsername);
           try(ResultSet result=pst.executeQuery()){
    ...
    public void checkMaxandMin(){
        ...
        ButtonModel income=jRadioButton2.getModel();
        ButtonModel expense=jRadioButton1.getModel();
        String sql;     
        if (buttonGroup2.getSelection().equals(income)){
            //Income
        sql="SELECT Max(Amount),Min(Amount) from income_pfms where Id=? and Username=?";
        jLabel26.setText("HIGHEST INCOME EVER");
        jLabel27.setText("LOWEST INCOME EVER");

        }
        else{
          //Expense
         jLabel26.setText("HIGHEST EXPENSE EVER");
        jLabel27.setText("LOWEST EXPENSE EVER"); 
         sql="SELECT Max(Amount),Min(Amount) from expense_pfms where Id=? and Username=?";
        }
        try(Connection con=Sql.getConnection()){
        ...
        try(ResultSet result=pst.executeQuery()){
            if(result.next()){
                Max=Integer.parseInt(result.getString("Max(Amount)"));
                Min=Integer.parseInt(result.getString("Min(Amount)"));
            }
        }
    ...
    highever.setText("$ "+String.valueOf(Max));
    lowever.setText("$ "+String.valueOf(Min));
    ...
    public void checkDetails(){
        // highest income ever and lowest income ever 
                   ...
                   thismonth=getdate.getMonth();
                               sql="SELECT * from income_pfms where Id=? and Username=?";
                                  ...
                                  try(ResultSet result1=pst.executeQuery()){
                                      while(result1.next()){
                                         try{
                                        java.util.Date date=new SimpleDateFormat("EEE MMM dd HH:mm:ss Z yyyy", Locale.US).parse(result.getString("Date")); 
...
public String calGross(){
   ...
   return Integer.toString(grossAmount);
    ...
    private void initComponents() {
        ...
        incomeReportTable = new javax.swing.JTable();
        ...
        avgmonth = new javax.swing.JLabel();
        avgweek = new javax.swing.JLabel();
        highever = new javax.swing.JLabel();
        jLabel26 = new javax.swing.JLabel();
        jLabel27 = new javax.swing.JLabel();
        lowever = new javax.swing.JLabel();
        jRadioButton1 = new javax.swing.JRadioButton();
        jRadioButton2 = new javax.swing.JRadioButton();
        jLabel31 = new javax.swing.JLabel();
        jLabel32 = new javax.swing.JLabel();
        jScrollPane4 = new javax.swing.JScrollPane();
        expenseReportTable = new javax.swing.JTable();
        ...
        reportLable.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel42.setText("EXPENSE");

        incomeReportTable.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        incomeReportTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        incomeReportTable.setShowHorizontalLines(false);
        incomeReportTable.setShowVerticalLines(false);
        jScrollPane2.setViewportView(incomeReportTable);
        if (incomeReportTable.getColumnModel().getColumnCount() > 0) {
            incomeReportTable.getColumnModel().getColumn(0).setMaxWidth(10);
            incomeReportTable.getColumnModel().getColumn(3).setMaxWidth(60);
            incomeReportTable.getColumnModel().getColumn(4).setMaxWidth(100);
            incomeReportTable.getColumnModel().getColumn(5).setMaxWidth(60);
            incomeReportTable.getColumnModel().getColumn(6).setMaxWidth(80);
        }
        ...
        jLabel2.setText("AVERAGE MONTLY INCOME");
        jLabel2.setEnabled(false);

        jLabel21.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        jLabel21.setText("AVERAGE WEEKLY INCOME");
        jLabel21.setEnabled(false);

        avgmonth.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        avgmonth.setText("VALUE");
        avgmonth.setEnabled(false);

        avgweek.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        avgweek.setText("VALUE");
        avgweek.setEnabled(false);

        highever.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        highever.setText("VALUE");
        ...
        lowever.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lowever.setText("VALUE");
        ...
        jRadioButton2.setMaximumSize(new java.awt.Dimension(15, 15));
                ...
                .addGroup(addBudgetPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(addBudgetPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(addBudgetPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            ...
                            .addComponent(avgmonth, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jLabel21)
                            .addComponent(avgweek, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jLabel26, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(highever, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jLabel27, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lowever, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        addBudgetPanelLayout.setVerticalGroup(
            ...
            .addGroup(addBudgetPanelLayout.createSequentialGroup()
                ...
                .addGap(5, 5, 5)
                .addComponent(avgmonth)
                .addGap(18, 18, 18)
                .addComponent(jLabel21)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(avgweek)
                .addGap(18, 18, 18)
                .addComponent(jLabel26)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(highever)
                .addGap(18, 18, 18)
                .addComponent(jLabel27)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lowever)
                .addContainerGap(71, Short.MAX_VALUE))
        );

        expenseReportTable.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        expenseReportTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        expenseReportTable.setShowHorizontalLines(false);
        expenseReportTable.setShowVerticalLines(false);
        jScrollPane4.setViewportView(expenseReportTable);
        if (expenseReportTable.getColumnModel().getColumnCount() > 0) {
            expenseReportTable.getColumnModel().getColumn(0).setMaxWidth(10);
            expenseReportTable.getColumnModel().getColumn(3).setMaxWidth(60);
            expenseReportTable.getColumnModel().getColumn(4).setMaxWidth(100);
            expenseReportTable.getColumnModel().getColumn(5).setMaxWidth(60);
            expenseReportTable.getColumnModel().getColumn(6).setMaxWidth(80);
        }
        ...
        expenceDisplayPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, expenceDisplayPanelLayout.createSequentialGroup()
                .addGroup(expenceDisplayPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, expenceDisplayPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(addBudgetPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(expenceDisplayPanelLayout.createSequentialGroup()
                        .addGap(9, 9, 9)
                        .addComponent(jLabel38)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        mainPanel.add(expenceDisplayPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 790, 440));
  ...
  new Main_Panel_Search(sessionId, sessionUsername).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_Panel_Report.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Main_Panel_Report(0).setVisible(true);
    ...
    private javax.swing.JLabel avgmonth;
    private javax.swing.JLabel avgweek;
    ...
    private javax.swing.JTable expenseReportTable;
    private javax.swing.JLabel grossAmountTextBox;
    private javax.swing.JLabel highever;
    private javax.swing.JLabel incomeMonth;
    private javax.swing.JTable incomeReportTable;
    ...
    private javax.swing.JLabel lowever;
