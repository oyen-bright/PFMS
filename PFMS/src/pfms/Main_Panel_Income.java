...
public class Main_Panel_Income extends javax.swing.JFrame {
    ...
    public Main_Panel_Income(int data, String data1) {
        this.data=data;
        this.data1=data1;
        this.getData_main();
    ...
    public Main_Panel_Income(int data) {
        this.data=data;
...
public void getTableInfo(){
     SimpleDateFormat formatter = new SimpleDateFormat("EEE-yyyy-MM-dd");
       ...
       DefaultTableModel model1 = (DefaultTableModel) expenseTable.getModel();
       ...
       try(Connection con=Sql.getConnection()){
           ...
           try(ResultSet result=pst.executeQuery()){
              ...
              if(expenseTable.getValueAt(0, 2)==null){
              
              }
              else{
                  selectCategoryTextBox.setText((expenseTable.getValueAt(0, 2)).toString());
              amountTextBox.setText((expenseTable.getValueAt(0, 3)).toString());
              dateTextBox.setText(firstdate);
              locationTextBox.setText((expenseTable.getValueAt(0, 4)).toString());
              noteTextBox.setText((expenseTable.getValueAt(0, 5)).toString()); 
              
                
         String statement="SELECT Number from income_pfms where Id=? and Username=? and Category=? and Amount=? and Location=? and Note =?  ";
            pst=con.prepareStatement(statement);
            pst.setInt(1, sessionId);
            pst.setString(2, sessionUsername);
            pst.setString(3, expenseTable.getValueAt(0, 2).toString());
            pst.setString(4, (expenseTable.getValueAt(0, 3).toString()).substring(1));
            pst.setString(5, expenseTable.getValueAt(0, 4).toString());
            pst.setString(6, expenseTable.getValueAt(0, 5).toString());
...
public void getDetails(){
    ...
    row=expenseTable.getSelectedRow();
             ...
             selectCategoryTextBox.setText((expenseTable.getValueAt(row, 2)).toString());
              amountTextBox.setText((expenseTable.getValueAt(row, 3)).toString());
             
              locationTextBox.setText((expenseTable.getValueAt(row, 4)).toString());
              noteTextBox.setText((expenseTable.getValueAt(row, 5)).toString()); 
       try(Connection con=Sql.getConnection()){
         String statement="SELECT Number, Date from income_pfms where Id=? and Username=? and Category=? and Amount=? and Location=? and Note =?  ";
            pst=con.prepareStatement(statement);
            pst.setInt(1, sessionId);
            pst.setString(2, sessionUsername);
            pst.setString(3, expenseTable.getValueAt(row, 2).toString());
            pst.setString(4, (expenseTable.getValueAt(row, 3).toString()).substring(1));
            pst.setString(5, expenseTable.getValueAt(row, 4).toString());
            pst.setString(6, expenseTable.getValueAt(row, 5).toString());
    ...
    private void initComponents() {
        ...
        mainPanel.add(incomeCatPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 160, 300, 420));
        ...
        expenseTable.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                expenseTableMouseReleased(evt);
            }
        });
        expenseTable.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                expenseTableKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                expenseTableKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(expenseTable);
        if (expenseTable.getColumnModel().getColumnCount() > 0) {
            expenseTable.getColumnModel().getColumn(0).setMaxWidth(20);
            expenseTable.getColumnModel().getColumn(3).setMaxWidth(60);
            expenseTable.getColumnModel().getColumn(5).setMaxWidth(60);
        }
        ...
        mainMainPanel.add(deleteButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 480, -1, -1));
    ...
    private void selectCategoryTextBoxMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_selectCategoryTextBoxMouseClicked
       ...
       if (selectCategoryTextBox.getText().equals("Gifts")){
            selectCateButtonGroup.setSelected(giftModel, true);
        }
        else if (selectCategoryTextBox.getText().equals("Other Incomes")){
            selectCateButtonGroup.setSelected(incomeOtherModel, true);
        }
        else if (selectCategoryTextBox.getText().equals("Interest Money")){
           selectCateButtonGroup.setSelected(intrestModel, true);
        }
        else if (selectCategoryTextBox.getText().equals("Loan Income")){
           selectCateButtonGroup.setSelected(loanModel, true);
        }
        else if (selectCategoryTextBox.getText().equals("Salary")){
           selectCateButtonGroup.setSelected(salaryModel, true);
        }
        else if (selectCategoryTextBox.getText().equals("Selling Income")){
           selectCateButtonGroup.setSelected(sellingModel, true);

        }
        else if (selectCategoryTextBox.getText().equals("Award")){
          selectCateButtonGroup.setSelected(awardModel, true);
        }
        else{
...
//        ButtonModel inincomeRadioButton = inIncomeRadioButton.getModel();
    ...
    private void expenseTableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_expenseTableKeyPressed
        // TODO add your handling code here:
        getDetails();
    }//GEN-LAST:event_expenseTableKeyPressed

    private void expenseTableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_expenseTableKeyReleased
        // TODO add your handling code here:
        getDetails();
    }//GEN-LAST:event_expenseTableKeyReleased

    private void expenseTableMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_expenseTableMouseReleased
        // TODO add your handling code here:
        getDetails();
    }//GEN-LAST:event_expenseTableMouseReleased
    ...
    private void deleteButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteButtonMouseClicked
       ...
       if (delNumber==0){
          ...
          System.out.println("was here");
            try(Connection con=Sql.getConnection()){
                String sql="Delete from income_pfms where Number=? and Id=? and Username=? ";
                pst=con.prepareStatement(sql);
    ...
    private void updateButonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateButonMouseClicked
        ...
        if(selectCategoryTextBox.getText().equals("") || selectCategoryTextBox.getText().equals("Select Category")
            ...
            try(Connection con=Sql.getConnection()){
                    ...
                    sql="UPDATE income_pfms SET Category = ?, Amount=?, Date=? ,Location=?, Note=?  Where Id = ? and Username=? and Number =?";
  ...
  new Main_Panel_Search(sessionId, sessionUsername).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_Panel_Income.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Main_Panel_Income(0).setVisible(true);
